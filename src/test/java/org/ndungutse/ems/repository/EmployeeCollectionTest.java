...
class EmployeeCollectionTest {
    ...
    void getEmployeeById() {
        ...
        Employee<String> employee = new Employee<>(employeeId, "Jane Doe",
                Department.HR, 4500, 4.0, 3, true);
    ...
    @Test
    void addEmployee() {
        String employeeId = collection.generateNewEmployeeId(); // UUID as
                                                                // String
        Employee<String> employee = new Employee<>(employeeId, "Eric Tuyizere",
    ...
    void addEmployee_shouldThrowException_whenSalaryIsNegative() {
        String employeeId = collection.generateNewEmployeeId();
        Employee<String> employee = new Employee<>(employeeId, "Eric Tuyizere",
                Department.IT, -1000, // negative salary
                4.5, 2, true);
    ...
    void addEmployee_shouldThrowException_whenRatingIsOutOfBounds() {
        String employeeId = collection.generateNewEmployeeId();
        Employee<String> employee = new Employee<>(employeeId, "Eric Tuyizere",
                Department.IT, 5000, 6.0, // invalid rating > 5
                2, true);
    ...
    void addEmployee_shouldThrowException_whenExperienceIsNegative() {
        ...
        assertTrue(exception.getMessage()
                .contains("Experience value cannot be less than zero"));
    }
    ...
    // Verify search employee by department throws an exception when department
    // is missing
    @Test
    ...
    void getEmployeesByDepartment_shouldReturnEmployeesInGivenDepartment() {
        ...
        Employee<String> employee1 = new Employee<>(employeeId1,
                "Eric Tuyizere", Department.IT, 5000, 4.5, 2, true);

        String employeeId2 = collection.generateNewEmployeeId();
        Employee<String> employee2 = new Employee<>(employeeId2, "Alice Doe",
                Department.HR, 4000, 4.0, 3, true);

        String employeeId3 = collection.generateNewEmployeeId();
        Employee<String> employee3 = new Employee<>(employeeId3, "John Smith",
                Department.IT, 5500, 4.2, 5, true);
        ...
        assertTrue(itEmployees.stream()
                .allMatch(e -> e.getDepartment() == Department.IT));
    }
